# -*- coding: utf-8 -*-
# based on cifar.py by Yukun Chen <cykustc@gmail.com>
# from https://github.com/tensorpack/tensorpack/blob/master/tensorpack/dataflow/dataset/cifar.py
...
# __all__ = ['set_Base', 'set5', 'set14']

DATA_URL_SET_5 = ('http://www.cs.toronto.edu/~kriz/cifar-10-python.tar.gz', 170498071)
DATA_URL_SET_14 = ('http://www.cs.toronto.edu/~kriz/cifar-100-python.tar.gz', 169001437)
...
class Set5(SetBase):
    """
    Produces [image, label] in Set5 dataset,
    image is 32x32x3 in the range [0,255].
    label is an int.
    """
